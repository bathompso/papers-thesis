...
\noindent \textbf{Inclination \& Orbital Period:} Mass determination using double-lined binaries is complicated by the inclination of the system. While RV studies can determine the orbital mechanics of the system, they cannot accurately determine masses fir all binaries. Without accurate masses for a large percentage of binary systems within the cluster, our science goals cannot be achieved. In addition, RV studies are limited by the resolution of their spectrometer; systems with doppler shifts less than the resolution of the spectrometer will not be registered as variable. Only binary systems with short enough orbital periods will produce large enough doppler shifts to be detected. \\
